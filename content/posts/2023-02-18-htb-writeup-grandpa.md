...
tags: ["Windows", "IIS 6.0 WebDAV", "Remote Buffer Overflow (RBO)", "CVE-2017-7269 (RBO)", "System Recognition (Windows)", "Local Privilege Escalation (LPE)", "Privesc - Churrasco Token Kidnapping (LPE)", "Reverse Shell", "OSCP Style"]
tools:
  - "ping"
  - "nmap"
  - "wappalizer"
...
### Investigando Alguna Vulnerabilidad para el Servicio Microsoft IIS httpd 6.0 {#Inv}
...
### Probando Variante de Exploit: Microsoft IIS 6.0 - WebDAV 'ScStoragePathFromUrl' Remote Buffer Overflow {#Exploit}
...
### Escalando Privilegios con Churrasco {#Churro}
