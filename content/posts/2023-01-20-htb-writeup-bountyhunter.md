...
tags: ["Linux", "PHP", "BurpSuite", "XXE Injection", "Python Vulnerability", "Abusing Sudoers Privileges", "Privesc - Abusing Sudoers Privileges", "OSCP Style"]
tools:
  - "ping"
  - "nmap"
  - "burpsuite"
...
### Creando Ticket que Modifica la Bash {#Ticket}
