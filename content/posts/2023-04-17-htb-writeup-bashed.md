...
tags: ["Linux", "Fuzzing", "PHP", "Abusing PHP WebShell", "Reverse Shell", "CronJob Exploitation", "Privesc - Abusing Sudoers Privileges", "OSCP Style"]
tools:
  - "ping"
  - "nmap"
  - "wappalizer"
...
### Ganando Acceso a la Máquina Víctima con Distintas Reverse Shell {#RevShells}
...
#### Utilizando Bash para Conectarnos de Manera Remota {#Bash}
...
#### Cargando una Reverse Shell {#Shell}
...
#### Usando Reverse Shell de Python {#Python}
...
### Acceso como Root Usando Tarea Cron {#Root}
