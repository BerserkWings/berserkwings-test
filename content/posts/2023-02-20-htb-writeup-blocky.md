...
tags: ["Linux", "Virtual Hosting", "Fuzzing", "PHP", "Wordpress", "Information Leakage", "Java Decompiler", "Wordpress Enumeration", "Abusing Wordpress Template", "Reverse Shell", "SSH Username Enumeration", "CVE-2018-15473", "Privesc - Abusing Sudoers Privileges", "OSCP Style"]
tools:
  - "ping"
  - "nmap"
  - "whatweb"
...
### Utilizando la Herramienta WPScan {#wpscan}
...
### Forma de Enumerar Usuarios de SSH {#SSH}
...
#### Probando Exploit: OpenSSH < 7.7 - Username Enumeration (2) {#PruebaExp}
...
### Probando Contraseña Encontrada en Servicio SSH {#SSH2}
...
### Ganando Acceso a Máquina Usando PhpMyAdmin y Wordpress {#PHP}
...
#### Suplantando Código de Template con Código de Reverse Shell de PentestMonkey para Ganar Acceso {#PHP2}
...
#### Suplantando Código de Template para Obtener una CMD {#PHP3}
